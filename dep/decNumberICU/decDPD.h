...
const uint16_t _BCD2DPD[2458]={    0,    1,    2,    3,    4,    5,    6,    7, 
...
const uint16_t _DPD2BCD[1024]={    0,    1,    2,    3,    4,    5,    6,    7, 
...
const uint16_t _BIN2DPD[1000]={    0,    1,    2,    3,    4,    5,    6,    7, 
...
const uint16_t _DPD2BIN[1024]={    0,    1,    2,    3,    4,    5,    6,    7, 
...
const uint32_t _DPD2BINK[1024]={       0,   1000,   2000,   3000,   4000,   5000, 
...
const uint32_t _DPD2BINM[1024]={0,   1000000,   2000000,   3000000,   4000000, 
