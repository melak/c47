...
void fnUserJM(uint16_t jmUser) {
  ...
  case USER_C43:          //USER
      fnUserJM(USER_RESET);
        ...
        kbd_usr[10].primary=ITM_cos;                      kbd_usr[10].fShifted=ITM_arccos;                  kbd_usr[10].gShifted=ITM_LBL;                     kbd_usr[10].keyLblAim=ITM_NULL;                   kbd_usr[10].primaryAim=ITM_K;                     kbd_usr[10].fShiftedAim=ITM_k;                    kbd_usr[10].gShiftedAim=ITM_NULL;                 kbd_usr[10].primaryTam=ITM_REG_K;                 
        kbd_usr[11].primary=ITM_tan;                      kbd_usr[11].fShifted=ITM_arctan;                  kbd_usr[11].gShifted=ITM_RTN;                     kbd_usr[11].keyLblAim=ITM_NULL;                   kbd_usr[11].primaryAim=ITM_L;                     kbd_usr[11].fShiftedAim=ITM_l;                    kbd_usr[11].gShiftedAim=ITM_NULL;                 kbd_usr[11].primaryTam=ITM_REG_L;                 
