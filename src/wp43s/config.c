  ...
  if(confirmation == NOT_CONFIRMED) {
    ...
    *(beginOfProgramMemory + 3) = 255; // .END.
    ...
    screenUpdatingMode = SCRUPD_AUTO;
      ...
      kbd_usr[21].primary=ITM_DIV;                      kbd_usr[21].fShifted=-MNU_STAT;                   kbd_usr[21].gShifted=-MNU_SUMS;                   kbd_usr[21].keyLblAim=ITM_SLASH;                  kbd_usr[21].primaryAim=ITM_S;                     kbd_usr[21].fShiftedAim=ITM_SLASH;                kbd_usr[21].gShiftedAim=ITM_SIGMA;                kbd_usr[21].primaryTam=ITM_DIV;                   
