...
void addTestPrograms(void) {
  uint32_t numberOfBytesUsed, numberOfBytesForTheTestPrograms = TO_BYTES(TO_BLOCKS(11511));
  ...
  if(confirmation == NOT_CONFIRMED) {
    ...
    *(beginOfProgramMemory + 3) = 255; // .END.
    ...
    screenUpdatingMode = SCRUPD_AUTO;
      ...
      kbd_usr[2].primary=ITM_SQUAREROOTX;               kbd_usr[2].fShifted=ITM_SQUARE;                   kbd_usr[2].gShifted=ITM_DMS;                      kbd_usr[2].keyLblAim=ITM_ROOT_SIGN;               kbd_usr[2].primaryAim=ITM_C;                      kbd_usr[2].fShiftedAim=ITM_ROOT_SIGN;             kbd_usr[2].gShiftedAim=ITM_CHI;                   kbd_usr[2].primaryTam=ITM_REG_C;                  
      kbd_usr[3].primary=ITM_LOG10;                     kbd_usr[3].fShifted=ITM_10x;                      kbd_usr[3].gShifted=ITM_dotD;                     kbd_usr[3].keyLblAim=ITM_NULL;                    kbd_usr[3].primaryAim=ITM_D;                      kbd_usr[3].fShiftedAim=ITM_LEFT_PARENTHESIS;      kbd_usr[3].gShiftedAim=ITM_DELTA;                 kbd_usr[3].primaryTam=ITM_REG_D;                  
      kbd_usr[4].primary=ITM_LN;                        kbd_usr[4].fShifted=ITM_EXP;                      kbd_usr[4].gShifted=ITM_toREC;                    kbd_usr[4].keyLblAim=ITM_NULL;                    kbd_usr[4].primaryAim=ITM_E;                      kbd_usr[4].fShiftedAim=ITM_ALOG_SYMBOL;           kbd_usr[4].gShiftedAim=ITM_EPSILON;               kbd_usr[4].primaryTam=ITM_NULL;                   
      kbd_usr[5].primary=ITM_XEQ;                       kbd_usr[5].fShifted=ITM_AIM;                      kbd_usr[5].gShifted=ITM_toPOL;                    kbd_usr[5].keyLblAim=ITM_NULL;                    kbd_usr[5].primaryAim=ITM_F;                      kbd_usr[5].fShiftedAim=ITM_LEFT_PARENTHESIS;      kbd_usr[5].gShiftedAim=ITM_NULL;                  kbd_usr[5].primaryTam=ITM_alpha;                  
      kbd_usr[6].primary=ITM_STO;                       kbd_usr[6].fShifted=ITM_MAGNITUDE;                kbd_usr[6].gShifted=ITM_ANGLE;                    kbd_usr[6].keyLblAim=ITM_NULL;                    kbd_usr[6].primaryAim=ITM_G;                      kbd_usr[6].fShiftedAim=ITM_VERTICAL_BAR;          kbd_usr[6].gShiftedAim=ITM_GAMMA;                 kbd_usr[6].primaryTam=ITM_NULL;                   
      ...
      kbd_usr[17].primary=ITM_UP;                       kbd_usr[17].fShifted=ITM_BST;                     kbd_usr[17].gShifted=ITM_RBR;                     kbd_usr[17].keyLblAim=ITM_UP;                     kbd_usr[17].primaryAim=ITM_UP;                    kbd_usr[17].fShiftedAim=ITM_NULL;                 kbd_usr[17].gShiftedAim=ITM_UP_ARROW;             kbd_usr[17].primaryTam=ITM_UP;                    
      ...
      kbd_usr[21].primary=ITM_SLASH;                    kbd_usr[21].fShifted=-MNU_STAT;                   kbd_usr[21].gShifted=-MNU_SUMS;                   kbd_usr[21].keyLblAim=ITM_SLASH;                  kbd_usr[21].primaryAim=ITM_S;                     kbd_usr[21].fShiftedAim=ITM_SLASH;                kbd_usr[21].gShiftedAim=ITM_SIGMA;                kbd_usr[21].primaryTam=ITM_DIV;                   
      kbd_usr[22].primary=ITM_DOWN;                     kbd_usr[22].fShifted=ITM_SST;                     kbd_usr[22].gShifted=ITM_STATUS;                  kbd_usr[22].keyLblAim=ITM_DOWN;                   kbd_usr[22].primaryAim=ITM_DOWN;                  kbd_usr[22].fShiftedAim=ITM_NULL;                 kbd_usr[22].gShiftedAim=ITM_DOWN_ARROW;           kbd_usr[22].primaryTam=ITM_DOWN;                  
      ...
      kbd_usr[32].primary=ITM_EXIT;                     kbd_usr[32].fShifted=ITM_OFF;                     kbd_usr[32].gShifted=-MNU_PRINT;                  kbd_usr[32].keyLblAim=ITM_EXIT;                   kbd_usr[32].primaryAim=ITM_EXIT;                  kbd_usr[32].fShiftedAim=ITM_OFF;                  kbd_usr[32].gShiftedAim=ITM_PRINTER;              kbd_usr[32].primaryTam=ITM_EXIT;                  
...
//JM LOAD ID
  strcpy(aimBuffer,"WP43S JM USER MODE");
  int16_t mem = stringByteLength(aimBuffer) + 1;
  reallocateRegister(REGISTER_T, dtString, TO_BLOCKS(mem), amNone);
  xcopy(REGISTER_STRING_DATA(REGISTER_T), aimBuffer, mem);

  char *build_str = "Compiled: " __DATE__;
  strcpy(aimBuffer,build_str);
  mem = stringByteLength(aimBuffer) + 1;
  reallocateRegister(REGISTER_Z, dtString, TO_BLOCKS(mem), amNone);
  xcopy(REGISTER_STRING_DATA(REGISTER_Z), aimBuffer, mem);

  #ifdef TWO_FILE_PGM
    strcpy(aimBuffer,"CUSTOM QSPI FILE REQUIRED");
    mem = stringByteLength(aimBuffer) + 1;
    reallocateRegister(REGISTER_Y, dtString, TO_BLOCKS(mem), amNone);
    xcopy(REGISTER_STRING_DATA(REGISTER_Y), aimBuffer, mem);
  #else
    strcpy(aimBuffer,"NO Custom QSPI FILE");
    mem = stringByteLength(aimBuffer) + 1;
    reallocateRegister(REGISTER_Y, dtString, TO_BLOCKS(mem), amNone);
    xcopy(REGISTER_STRING_DATA(REGISTER_Y), aimBuffer, mem);
  #endif //TWO_FILE_PGM
