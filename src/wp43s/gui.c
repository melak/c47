...
#ifdef V43
GtkWidget *btn51A,  *btn52A,  *btn53A,  *btn54A  ;  //JMV43           //vv dr - new AIM
GtkWidget *lbl51Fa, *lbl52Fa, *lbl53Fa, *lbl54Fa; //JMV43           //^^
#else
...
#ifdef V43
GtkWidget *btn61A,  *btn62A,  *btn63A,  *btn64A;              //vv dr - new AIM
GtkWidget *lbl61Fa, *lbl62Fa, *lbl63Fa, *lbl64Fa;             //^^
#else
...
#ifdef V43
GtkWidget *btn71A,  *btn72A,  *btn73A,  *btn74A ;              //vv dr - new AIM
GtkWidget *lbl71Fa, *lbl72Fa, *lbl73Fa, *lbl74Fa;             //^^
#else
...
#ifdef V43
GtkWidget *btn81A,  *btn82A,  *btn83A,  *btn84A;              //vv dr - new AIM
GtkWidget *lbl81Fa, *lbl82Fa, *lbl83Fa, *lbl84Fa;             //^^
#else
...
void prepareCssData(void) {
  ...
  #ifdef V43
  #define CSSFILE "wp43s_pre_V43.css"
  #else
...
void moveLabels(void) {
  ...
  gtk_widget_get_preferred_size(  lbl21Fa, NULL, &lblF);                                                                          //vv JM
  gtk_fixed_move(GTK_FIXED(grid), lbl21Fa, (2*xPos+2*KEY_WIDTH_1+2)/2 + 2, yPos);    //JM SPECIAL Position for template on the side.
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl22Fa, (2*xPos+2*KEY_WIDTH_1+2)/2 + 2, yPos);    //JM SPECIAL Position for template on the side.
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl23Fa, (2*xPos+2*KEY_WIDTH_1+2)/2 + 2, yPos);    //JM SPECIAL Position for template on the side. 
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl42Fa, (2*xPos+KEY_WIDTH_1-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl43Fa, (2*xPos+KEY_WIDTH_1-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
...
//  gtk_fixed_move(GTK_FIXED(grid), lbl51Gr, xPos+KEY_WIDTH_1*2/3,                              yPos - Y_OFFSET_GREEK); //JMAHOME
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl51Fa, (2*xPos+KEY_WIDTH_2-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
#endif
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl61Fa, (2*xPos+KEY_WIDTH_2-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
#endif
  ...
  yPos += DELTA_KEYS_Y + 1;
#ifdef V43 //Removed commnets of this section
gtk_widget_get_preferred_size(  lbl71F, NULL, &lblF);//JMV43 //JM REMOVE SHIFT LABELS
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl71Fa, (2*xPos+KEY_WIDTH_2-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
#endif
  xPos += DELTA_KEYS_X + 18;
...
//JM^^
...
#ifdef V43 //Added this whole section
  gtk_widget_get_preferred_size(  lbl81F, NULL, &lblF);
  gtk_widget_get_preferred_size(  lbl81G, NULL, &lblG);
  ...
  gtk_widget_get_preferred_size(  lbl81Fa, NULL, &lblF);                                                                        //vv dr - new AIM
  gtk_fixed_move(GTK_FIXED(grid), lbl81Fa, (2*xPos+KEY_WIDTH_2-lblF.width-GAP-lblG.width+2)/2, yPos - Y_OFFSET_SHIFTED_LABEL);  //^^
#endif
...
//gtk_fixed_move(GTK_FIXED(grid), lbl84Gr, (2*xPos+KEY_WIDTH_2-GAP-lblG.width+2)/2,           yPos + GAP - Y_OFFSET_SHIFTED_LABEL); //JM ALPHA BLUE MENU LABELS //vv dr - new AIM
  ...
  gtk_fixed_move(GTK_FIXED(grid), lbl84Fa, (2*xPos+2*KEY_WIDTH_2+2)/2 + 2, yPos);    //JM SPECIAL Position for template on the side.
  #endif
...
void labelCaptionAim(const calcKey_t *key, GtkWidget *button, GtkWidget *lblGreek, GtkWidget *lblL) {
  ...
  /*if(key->keyLblAim == ITM_NULL) {    //vv dr - new AIM
    lbl[0] = 0;
  }
  else {
...
#ifdef V43
  gtk_widget_show(lbl71F);//JMV43 //JM REMOVE SHIFT LABEL
  gtk_widget_show(lbl71G);//JMV43 //JM REMOVE SHIFT LABEL
#endif
...
#ifdef V43
  gtk_widget_show(lbl81G);//JMV43 //JM
#endif
...
#else
  labelCaptionAimFa(keys, lbl51Fa);                //JMV43
  labelCaptionAim(keys++, btn51A, lbl51Gr, lbl51L);//JMV43
#endif
...
#else
  labelCaptionAim(keys++, btn55, lbl55Gr, lbl55L);//JMV43
#endif  

#ifndef V43
  labelCaptionAim(keys++, btn61,  lbl61Gr, lbl61L);
#else
  labelCaptionAimFa(keys, lbl61Fa);                //JMV43
  labelCaptionAim(keys++, btn61A, lbl61Gr, lbl61L);//JMV43
#endif
...
#else
  labelCaptionAim(keys++, btn65, lbl65Gr, lbl65L);//JMV43
#endif  

#ifndef V43
  labelCaptionAim(keys++, btn71,  lbl71Gr, lbl71L);
#else
  labelCaptionAimFa(keys, lbl71Fa);                //JMV43
  labelCaptionAim(keys++, btn71A, lbl71Gr, lbl71L);//JMV43
#endif
...
#else
  labelCaptionAim(keys++, btn75, lbl75Gr, lbl75L);//JMV43
#endif  

#ifndef V43
  labelCaptionAim(keys++, btn81,  lbl81Gr, lbl81L);
#else
  labelCaptionAimFa(keys, lbl81Fa);                //JMV43
  labelCaptionAim(keys++, btn81A, lbl81Gr, lbl81L);//JMV43
#endif
...
#else
  labelCaptionAim(keys++, btn85, lbl85Gr, lbl85L);//JMV43
#endif  
...
#endif //JM Layout
#if defined(JM_LAYOUT_1A) && !defined(V43)//JM LAYOUT 1
...
#if defined(JM_LAYOUT_1A)  //JM LAYOUT 1. FINAL. Show colour band next to LCD
  #ifdef S43               //JM ONLY DISPLAY COLOUR BANDS ON SCREEN FOR 43S
...
//  gtk_widget_set_name(lbl21Fa,  "fShiftedUnderline"); //JMALPHA2
  ...
  g_signal_connect(btn21A, "pressed", G_CALLBACK(btnPressed), "00");    //vv dr - new AIM
  g_signal_connect(btn22A, "pressed", G_CALLBACK(btnPressed), "01");
  g_signal_connect(btn23A, "pressed", G_CALLBACK(btnPressed), "02");
  g_signal_connect(btn24A, "pressed", G_CALLBACK(btnPressed), "03");
  g_signal_connect(btn25A, "pressed", G_CALLBACK(btnPressed), "04");
  g_signal_connect(btn26A, "pressed", G_CALLBACK(btnPressed), "05");
  g_signal_connect(btn21A, "released", G_CALLBACK(btnReleased), "00");
  g_signal_connect(btn22A, "released", G_CALLBACK(btnReleased), "01");
  g_signal_connect(btn23A, "released", G_CALLBACK(btnReleased), "02");
  g_signal_connect(btn24A, "released", G_CALLBACK(btnReleased), "03");
  g_signal_connect(btn25A, "released", G_CALLBACK(btnReleased), "04");
  g_signal_connect(btn26A, "released", G_CALLBACK(btnReleased), "05");  //^^
...
//JM  lbl35H  = gtk_label_new("");                                               // ("\u03b7"); // eta          //JM removed1
  ...
  g_signal_connect(btn31A, "pressed", G_CALLBACK(btnPressed), "06");    //vv dr - new AIM
  g_signal_connect(btn32A, "pressed", G_CALLBACK(btnPressed), "07");
  g_signal_connect(btn33A, "pressed", G_CALLBACK(btnPressed), "08");
  g_signal_connect(btn34A, "pressed", G_CALLBACK(btnPressed), "09");
  g_signal_connect(btn35A, "pressed", G_CALLBACK(btnPressed), "10");
  g_signal_connect(btn36A, "pressed", G_CALLBACK(btnPressed), "11");
  g_signal_connect(btn31A, "released", G_CALLBACK(btnReleased), "06");
  g_signal_connect(btn32A, "released", G_CALLBACK(btnReleased), "07");
  g_signal_connect(btn33A, "released", G_CALLBACK(btnReleased), "08");
  g_signal_connect(btn34A, "released", G_CALLBACK(btnReleased), "09");
  g_signal_connect(btn35A, "released", G_CALLBACK(btnReleased), "10");
  g_signal_connect(btn36A, "released", G_CALLBACK(btnReleased), "11");  //^^
...
//  gtk_fixed_put(GTK_FIXED(grid), lbl34H, xPos + KEY_WIDTH_1 + X_OFFSET_LETTER, yPos -  1);               //JM CAPS //JMALPHA temporary remove A from J
  ...
  g_signal_connect(btn42A, "pressed", G_CALLBACK(btnPressed), "13");    //vv dr - new AIM
  g_signal_connect(btn43A, "pressed", G_CALLBACK(btnPressed), "14");
  g_signal_connect(btn44A, "pressed", G_CALLBACK(btnPressed), "15");
  g_signal_connect(btn42A, "released", G_CALLBACK(btnReleased), "13");
  g_signal_connect(btn43A, "released", G_CALLBACK(btnReleased), "14");
  g_signal_connect(btn44A, "released", G_CALLBACK(btnReleased), "15");  //^^
...
#endif
#ifdef V43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn51A), "N"); //JMV43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn52A), "O"); //JMV43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn53A), "P"); //JMV43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn54A), "Q"); //JMV43
//  gtk_widget_set_tooltip_text(GTK_WIDGET(btn55A), "R"); //JMV43 ??
#else
...
#ifdef V43
  gtk_widget_set_size_request(btn51A, KEY_WIDTH_1, 0);//JMV43
#endif
...
#ifdef V43
  g_signal_connect(btn51A, "pressed", G_CALLBACK(btnPressed), "17");//JMV43
#endif
  g_signal_connect(btn52A, "pressed", G_CALLBACK(btnPressed), "18");    //vv dr - new AIM
  g_signal_connect(btn53A, "pressed", G_CALLBACK(btnPressed), "19");
  g_signal_connect(btn54A, "pressed", G_CALLBACK(btnPressed), "20");
#ifndef V43
  g_signal_connect(btn55A, "pressed", G_CALLBACK(btnPressed), "21");
#endif

#ifdef V43
  g_signal_connect(btn51A, "released", G_CALLBACK(btnReleased), "17");//JMV43
#endif
  g_signal_connect(btn52A, "released", G_CALLBACK(btnReleased), "18");
  g_signal_connect(btn53A, "released", G_CALLBACK(btnReleased), "19");
  g_signal_connect(btn54A, "released", G_CALLBACK(btnReleased), "20");
#ifndef V43
  g_signal_connect(btn55A, "released", G_CALLBACK(btnReleased), "21");  //^^
#endif
...
#ifdef V43
  gtk_fixed_put(GTK_FIXED(grid), lbl51Fa, 0, 0);//JMV43
#endif
...
#ifdef V43
  gtk_fixed_put(GTK_FIXED(grid), lbl51L, xPos + KEY_WIDTH_1 + X_OFFSET_LETTER, yPos + Y_OFFSET_LETTER);//JMV43  //JM remove arrow in text
  gtk_fixed_put(GTK_FIXED(grid), btn51A, xPos,                         yPos);   //JMV43
#endif
...
#endif
#ifdef V43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn61A), "S");
...
//  gtk_widget_set_tooltip_text(GTK_WIDGET(btn65A), "W"); //^^
...
#ifdef V43
  gtk_widget_set_size_request(btn61A, KEY_WIDTH_1, 0);//JMV43
#endif
...
#ifdef V43
  g_signal_connect(btn61A, "pressed", G_CALLBACK(btnPressed), "22");//JMV43
#endif
  g_signal_connect(btn62A, "pressed", G_CALLBACK(btnPressed), "23");    //vv - new AIM
  g_signal_connect(btn63A, "pressed", G_CALLBACK(btnPressed), "24");
  g_signal_connect(btn64A, "pressed", G_CALLBACK(btnPressed), "25");
#ifndef V43
  g_signal_connect(btn65A, "pressed", G_CALLBACK(btnPressed), "26");
#endif  
#ifdef V43
  g_signal_connect(btn61A, "released", G_CALLBACK(btnReleased), "22");//JMV43
#endif
  g_signal_connect(btn62A, "released", G_CALLBACK(btnReleased), "23");
  g_signal_connect(btn63A, "released", G_CALLBACK(btnReleased), "24");
  g_signal_connect(btn64A, "released", G_CALLBACK(btnReleased), "25");
#ifndef V43
  g_signal_connect(btn65A, "released", G_CALLBACK(btnReleased), "26");  //^^
#endif
...
#ifdef V43
  gtk_fixed_put(GTK_FIXED(grid), lbl61Fa, 0, 0);//JMV43
#endif
  ...
  gtk_fixed_put(GTK_FIXED(grid), btn61A, xPos,                         yPos);   //dr - new AIM
#endif
...
#endif
#ifdef V43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn71A), "W");
...
#ifdef V43
  gtk_widget_set_size_request(btn71A, KEY_WIDTH_1, 0);//JMV43
#endif
...
#ifdef V43
  g_signal_connect(btn71A, "pressed", G_CALLBACK(btnPressed), "27");//JMV43
#endif
  g_signal_connect(btn72A, "pressed", G_CALLBACK(btnPressed), "28");    //vv dr - new AIM
  g_signal_connect(btn73A, "pressed", G_CALLBACK(btnPressed), "29");
  g_signal_connect(btn74A, "pressed", G_CALLBACK(btnPressed), "30");
#ifndef V43
  g_signal_connect(btn75A, "pressed", G_CALLBACK(btnPressed), "31");
#endif

#ifdef V43
  g_signal_connect(btn71A, "released", G_CALLBACK(btnReleased), "27");//JMV43
#endif
  g_signal_connect(btn72A, "released", G_CALLBACK(btnReleased), "28");
  g_signal_connect(btn73A, "released", G_CALLBACK(btnReleased), "29");
  g_signal_connect(btn74A, "released", G_CALLBACK(btnReleased), "30");
#ifndef V43
  g_signal_connect(btn75A, "released", G_CALLBACK(btnReleased), "31");  //^^
#endif
...
#ifdef V43
  gtk_fixed_put(GTK_FIXED(grid), lbl71Fa, 0, 0);//JMV43
#endif
...
//lbl84H  = gtk_label_new("\u2399"); // Printer   //JM: WHY DID THIS LINE COME BACK ??
...
#ifdef V43
  gtk_widget_set_size_request(btn81A, KEY_WIDTH_1, 0);//JMV43
#endif
...
#ifdef V43
  g_signal_connect(btn81A, "pressed", G_CALLBACK(btnPressed), "32");//JMV43
#endif
  g_signal_connect(btn82A, "pressed", G_CALLBACK(btnPressed), "33");    //vv dr - new AIM
  g_signal_connect(btn83A, "pressed", G_CALLBACK(btnPressed), "34");
  g_signal_connect(btn84A, "pressed", G_CALLBACK(btnPressed), "35");
#ifndef V43
  g_signal_connect(btn85A, "pressed", G_CALLBACK(btnPressed), "36");
#endif  
#ifdef V43
  g_signal_connect(btn81A, "released", G_CALLBACK(btnReleased), "32");//JMV43
#endif
  g_signal_connect(btn82A, "released", G_CALLBACK(btnReleased), "33");
  g_signal_connect(btn83A, "released", G_CALLBACK(btnReleased), "34");
  g_signal_connect(btn84A, "released", G_CALLBACK(btnReleased), "35");
#ifndef V43
  g_signal_connect(btn85A, "released", G_CALLBACK(btnReleased), "36");  //^^
#endif
...
#ifdef V43
  gtk_fixed_put(GTK_FIXED(grid), lbl81Fa, 0, 0);//JMV43
#endif
  ...
  gtk_fixed_put(GTK_FIXED(grid), btn81A, xPos,                         yPos);   //dr - new AIM
