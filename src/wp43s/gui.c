...
#ifdef V43
GtkWidget *btn51A,  *btn52A,  *btn53A,  *btn54A,  *btn55A;  //JMV43           //vv dr - new AIM
GtkWidget *lbl51Fa, *lbl52Fa, *lbl53Fa, *lbl54Fa, *lbl55Fa; //JMV43           //^^
#else
...
//#endif
#ifdef V43
  gtk_widget_set_tooltip_text(GTK_WIDGET(btn52A), "N"); //JMV43
