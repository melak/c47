...
void generateAllConstants(void) {
  ...
  generateConstantArray("1",             "+1.000000000000000000000000000000000000000000000000000000e+00"); // cnst151
  generateConstantArray("3on2",          "+1.500000000000000000000000000000000000000000000000000000e+00"); // cnst152
  generateConstantArray("piOn2",         "+1.570796326794896619231321691639751442098584699687552910e+00"); // cnst153
  ...
  generateConstantArray("pi",            "+3.141592653589793238462643383279502884197169399375105821e+00"); // cnst159

  generateConstantArray("4",             "+4.000000000000000000000000000000000000000000000000000000e+00"); // cnst160
  generateConstantArray("3piOn2",        "+4.712388980384689857693965074919254326295754099062658731e+00"); // cnst161
  generateConstantArray("5",             "+5.000000000000000000000000000000000000000000000000000000e+00"); // cnst162
  generateConstantArray("6",             "+6.000000000000000000000000000000000000000000000000000000e+00"); // cnst163
  generateConstantArray("2pi",           "+6.283185307179586476925286766559005768394338798750211642e+00"); // cnst164
  generateConstantArray("8",             "+8.000000000000000000000000000000000000000000000000000000e+00"); // cnst165
  generateConstantArray("9",             "+9.000000000000000000000000000000000000000000000000000000e+00"); // cnst166
  generateConstantArray("10",            "+1.000000000000000000000000000000000000000000000000000000e+01"); // cnst167
  generateConstantArray("12",            "+1.200000000000000000000000000000000000000000000000000000e+01"); // cnst168
  generateConstantArray("16",            "+1.600000000000000000000000000000000000000000000000000000e+01"); // cnst169
  generateConstantArray("20",            "+2.000000000000000000000000000000000000000000000000000000e+01"); // cnst170
  //generateConstantArray("21",            "+2.100000000000000000000000000000000000000000000000000000e+01"); // cnst171     used for Lanczos N=22
  //generateConstantArray("gammaR",        "+2.311891000000000000000000000000000000000000000000000000e+01"); // cnst172     used for Lanczos N=22
  generateConstantArray("25",            "+2.500000000000000000000000000000000000000000000000000000e+01"); // cnst171
  generateConstantArray("27",            "+2.700000000000000000000000000000000000000000000000000000e+01"); // cnst172
  generateConstantArray("29",            "+2.900000000000000000000000000000000000000000000000000000e+01"); // cnst173     used for Lanczos N=30
  generateConstantArray("30",            "+3.000000000000000000000000000000000000000000000000000000e+01"); // cnst174
  generateConstantArray("gammaR",        "+3.143188335932791233062744140625000000000000000000000000e+01"); // cnst175     used for Lanczos N=30
  generateConstantArray("32",            "+3.200000000000000000000000000000000000000000000000000000e+01"); // cnst176
  generateConstantArray("36",            "+3.600000000000000000000000000000000000000000000000000000e+01"); // cnst177
  generateConstantArray("47",            "+4.700000000000000000000000000000000000000000000000000000e+01"); // cnst178
  generateConstantArray("180onPi",       "+5.729577951308232087679815481410517033240547246656432155e+01"); // cnst179
  generateConstantArray("60",            "+6.000000000000000000000000000000000000000000000000000000e+01"); // cnst180
  generateConstantArray("200onPi",       "+6.366197723675813430755350534900574481378385829618257950e+01"); // cnst181
  generateConstantArray("125",           "+1.250000000000000000000000000000000000000000000000000000e+02"); // cnst182
  generateConstantArray("150",           "+1.500000000000000000000000000000000000000000000000000000e+02"); // cnst183
  generateConstantArray("205",           "+2.050000000000000000000000000000000000000000000000000000e+02"); // cnst184
  generateConstantArray("360",           "+3.600000000000000000000000000000000000000000000000000000e+02"); // cnst185
  generateConstantArray("400",           "+4.000000000000000000000000000000000000000000000000000000e+02"); // cnst186
  generateConstantArray("600",           "+6.000000000000000000000000000000000000000000000000000000e+02"); // cnst187
  generateConstantArray("1000",          "+1.000000000000000000000000000000000000000000000000000000e+03"); // cnst188
  generateConstantArray("2100",          "+2.100000000000000000000000000000000000000000000000000000e+03"); // cnst189
  generateConstantArray("2520",          "+2.520000000000000000000000000000000000000000000000000000e+03"); // cnst190
  generateConstantArray("3600",          "+3.600000000000000000000000000000000000000000000000000000e+03"); // cnst191
  generateConstantArray("6000",          "+6.000000000000000000000000000000000000000000000000000000e+03"); // cnst192
  generateConstantArray("9999",          "+9.999000000000000000000000000000000000000000000000000000e+03"); // cnst193
  generateConstantArray("10000",         "+1.000000000000000000000000000000000000000000000000000000e+04"); // cnst194
  generateConstantArray("25200",         "+2.520000000000000000000000000000000000000000000000000000e+04"); // cnst195
  generateConstantArray("42000",         "+4.200000000000000000000000000000000000000000000000000000e+04"); // cnst196
  generateConstantArray("73766",         "+7.376600000000000000000000000000000000000000000000000000e+04"); // cnst197
  generateConstantArray("1e6",           "+1.000000000000000000000000000000000000000000000000000000e+06"); // cnst198
  generateConstantArray("1e8",           "+1.000000000000000000000000000000000000000000000000000000e+08"); // cnst199
  generateConstantArray("1e9",           "+1.000000000000000000000000000000000000000000000000000000e+09"); // cnst200
  generateConstantArray("2p32",          "+4.294967296000000000000000000000000000000000000000000000e+09"); // cnst201
  generateConstantArray("1e32",          "+1.000000000000000000000000000000000000000000000000000000e+32"); // cnst202
  generateConstantArray("1e_10000",      "+1.000000000000000000000000000000000000000000000000000000e-10000"); // cnst203
  generateConstantArray("995on1000",     "+9.950000000000000000000000000000000000000000000000000000e-01"); // cnst204
  generateConstantArray("1e_32",         "+1.000000000000000000000000000000000000000000000000000000e-32"); // cnst205
  generateConstantArray("rt3",           "+1.732050807568877293527446341505872366942805253810380628e+00"); // cnst206 if the number of constants changes: don't forget to update NUMBER_OF_CONSTANTS_* in defines.h
