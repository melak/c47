...
void generateAllConstants(void) {
  ...
  generateConstantArray("10",            "+1.000000000000000000000000000000000000000000000000000000e+01"); // cnst160
  ...
  generateConstantArray("29",            "+2.900000000000000000000000000000000000000000000000000000e+01"); // cnst162     used for Lanczos N=30
  generateConstantArray("gammaR",        "+3.143188335932791233062744140625000000000000000000000000e+01"); // cnst163     used for Lanczos N=30
  generateConstantArray("32",            "+3.200000000000000000000000000000000000000000000000000000e+01"); // cnst164
  generateConstantArray("36",            "+3.600000000000000000000000000000000000000000000000000000e+01"); // cnst165
  generateConstantArray("47",            "+4.700000000000000000000000000000000000000000000000000000e+01"); // cnst166
  generateConstantArray("180onPi",       "+5.729577951308232087679815481410517033240547246656432155e+01"); // cnst167
  generateConstantArray("60",            "+6.000000000000000000000000000000000000000000000000000000e+01"); // cnst168
  generateConstantArray("200onPi",       "+6.366197723675813430755350534900574481378385829618257950e+01"); // cnst169
  generateConstantArray("205",           "+2.050000000000000000000000000000000000000000000000000000e+02"); // cnst170
  generateConstantArray("360",           "+3.600000000000000000000000000000000000000000000000000000e+02"); // cnst171
  generateConstantArray("400",           "+4.000000000000000000000000000000000000000000000000000000e+02"); // cnst172
  generateConstantArray("1000",          "+1.000000000000000000000000000000000000000000000000000000e+03"); // cnst173
  generateConstantArray("3600",          "+3.600000000000000000000000000000000000000000000000000000e+03"); // cnst174
  generateConstantArray("9999",          "+9.999000000000000000000000000000000000000000000000000000e+03"); // cnst175
  generateConstantArray("10000",         "+1.000000000000000000000000000000000000000000000000000000e+04"); // cnst176
  generateConstantArray("1e6",           "+1.000000000000000000000000000000000000000000000000000000e+06"); // cnst177
  generateConstantArray("1e8",           "+1.000000000000000000000000000000000000000000000000000000e+08"); // cnst178
  generateConstantArray("1e9",           "+1.000000000000000000000000000000000000000000000000000000e+09"); // cnst179
  generateConstantArray("2p32",          "+4.294967296000000000000000000000000000000000000000000000e+09"); // cnst180
  generateConstantArray("1e32",          "+1.000000000000000000000000000000000000000000000000000000e+32"); // cnst181
  generateConstantArray("1e_10000",      "+1.000000000000000000000000000000000000000000000000000000e-10000"); // cnst182
  generateConstantArray("995on1000",     "+9.950000000000000000000000000000000000000000000000000000e-01"); // cnst183
  ...
  // source: https://www.vttoth.com/FILES/lanczos.tgz
  generateConstantArray51("gammaC00",      "+2.506628274631000502415765284811045253006986740036318756703152698088652909808141644264478158114643"); // cnst185
  generateConstantArray51("gammaC01",      "+90795313438554.12585760728412902207185494121818510422990562390199419594778421509725059250660477478"); // cnst186
  generateConstantArray51("gammaC02",      "-966788810976616.3165238613163922965882171247384377771690792930892852741666385482155753752741846215"); // cnst187
  generateConstantArray51("gammaC03",      "+4800584619652903.130520636355077553806266769741879659498830407152738371167934130745600044623388068"); // cnst188
  generateConstantArray51("gammaC27",      "+0.000000028425884712306176285600873249949436913248124688912080334562388569408577988201187292514310"); // cnst212
  generateConstantArray51("gammaC28",      "-0.000000000001515686855682081535390179935440192138970398946754350022046202956603870401666503058594"); // cnst213
  generateConstantArray51("gammaC29",      "+0.000000000000000003727184110478268994444830355775133199862144652804253659035860755294511160286895"); // cnst214

  // Array angle180
  generateConstantArray51("pi_51",         "+3.141592653589793238462643383279502884197169399375105821e+00"); // cnst215
  generateConstantArray51("200",           "+2.000000000000000000000000000000000000000000000000000000e+02"); // cnst216
  generateConstantArray51("180",           "+1.800000000000000000000000000000000000000000000000000000e+02"); // cnst217

  // Array angle90
  generateConstantArray51("piOn2_51",      "+1.570796326794896619231321691639751442098584699687552910e+00"); // cnst218
  generateConstantArray51("100",           "+1.000000000000000000000000000000000000000000000000000000e+02"); // cnst219
  generateConstantArray51("90",            "+9.000000000000000000000000000000000000000000000000000000e+01"); // cnst220

  // Array angle45
  generateConstantArray51("piOn4_51",      "+7.853981633974483096156608458198757210492923498437764552e-01"); // cnst221
  generateConstantArray51("50",            "+5.000000000000000000000000000000000000000000000000000000e+01"); // cnst222
  generateConstantArray51("45",            "+4.500000000000000000000000000000000000000000000000000000e+01"); // cnst223
  ...
  generateConstantArray34("_4712",       "-4.712000000000000000000000000000000000000000000000000000e+03"); // cnst225
  generateConstantArray34("0",           "+0.000000000000000000000000000000000000000000000000000000e+00"); // cnst226
  generateConstantArray34("1e_32",       "+1.000000000000000000000000000000000000000000000000000000e-32"); // cnst227
  generateConstantArray34("1e_6",        "+1.000000000000000000000000000000000000000000000000000000e-06"); // cnst228
  generateConstantArray34("1e_4",        "+1.000000000000000000000000000000000000000000000000000000e-04"); // cnst229
  generateConstantArray34("1on2",        "+5.000000000000000000000000000000000000000000000000000000e-01"); // cnst230
  generateConstantArray34("1",           "+1.000000000000000000000000000000000000000000000000000000e+00"); // cnst231
  generateConstantArray34("2",           "+2.000000000000000000000000000000000000000000000000000000e+00"); // cnst232
  generateConstantArray34("3",           "+3.000000000000000000000000000000000000000000000000000000e+00"); // cnst233
  generateConstantArray34("4",           "+4.000000000000000000000000000000000000000000000000000000e+00"); // cnst234
  generateConstantArray34("5",           "+5.000000000000000000000000000000000000000000000000000000e+00"); // cnst235
  generateConstantArray34("2pi",         "+6.283185307179586476925286766559005768394338798750211642e+00"); // cnst236
  generateConstantArray34("7",           "+7.000000000000000000000000000000000000000000000000000000e+00"); // cnst237
  generateConstantArray34("9",           "+9.000000000000000000000000000000000000000000000000000000e+00"); // cnst238
  generateConstantArray34("12",          "+1.200000000000000000000000000000000000000000000000000000e+01"); // cnst239
  generateConstantArray34("14",          "+1.400000000000000000000000000000000000000000000000000000e+01"); // cnst240
  generateConstantArray34("24",          "+2.400000000000000000000000000000000000000000000000000000e+01"); // cnst241
  generateConstantArray34("28",          "+2.800000000000000000000000000000000000000000000000000000e+01"); // cnst242
  generateConstantArray34("31",          "+3.100000000000000000000000000000000000000000000000000000e+01"); // cnst243
  generateConstantArray34("38",          "+3.800000000000000000000000000000000000000000000000000000e+01"); // cnst244
  generateConstantArray34("60",          "+6.000000000000000000000000000000000000000000000000000000e+01"); // cnst245
  generateConstantArray34("100",         "+1.000000000000000000000000000000000000000000000000000000e+02"); // cnst246
  generateConstantArray34("153",         "+1.530000000000000000000000000000000000000000000000000000e+02"); // cnst247
  generateConstantArray34("275",         "+2.750000000000000000000000000000000000000000000000000000e+02"); // cnst248
  generateConstantArray34("367",         "+3.670000000000000000000000000000000000000000000000000000e+02"); // cnst249
  generateConstantArray34("400",         "+4.000000000000000000000000000000000000000000000000000000e+02"); // cnst250
  generateConstantArray34("1401",        "+1.401000000000000000000000000000000000000000000000000000e+03"); // cnst251
  generateConstantArray34("1461",        "+1.461000000000000000000000000000000000000000000000000000e+03"); // cnst252
  generateConstantArray34("3600",        "+3.600000000000000000000000000000000000000000000000000000e+03"); // cnst253
  generateConstantArray34("4716",        "+4.716000000000000000000000000000000000000000000000000000e+03"); // cnst254
  generateConstantArray34("4800",        "+4.800000000000000000000000000000000000000000000000000000e+03"); // cnst255
  generateConstantArray34("4900",        "+4.900000000000000000000000000000000000000000000000000000e+03"); // cnst256
  generateConstantArray34("5001",        "+5.001000000000000000000000000000000000000000000000000000e+03"); // cnst257
  generateConstantArray34("32075",       "+3.207500000000000000000000000000000000000000000000000000e+04"); // cnst258
  generateConstantArray34("43200",       "+4.320000000000000000000000000000000000000000000000000000e+04"); // cnst259
  generateConstantArray34("65535",       "+6.553500000000000000000000000000000000000000000000000000e+04"); // cnst260
  generateConstantArray34("86400",       "+8.640000000000000000000000000000000000000000000000000000e+04"); // cnst261
  generateConstantArray34("146097",      "+1.460970000000000000000000000000000000000000000000000000e+05"); // cnst262
  generateConstantArray34("274277",      "+2.742770000000000000000000000000000000000000000000000000e+05"); // cnst263
  generateConstantArray34("1e6",         "+1.000000000000000000000000000000000000000000000000000000e+06"); // cnst264
  generateConstantArray34("1729777",     "+1.729777000000000000000000000000000000000000000000000000e+06"); // cnst265
  generateConstantArray34("2p32",        "+4.294967296000000000000000000000000000000000000000000000e+09"); // cnst266
  generateConstantArray34("maxDate",     "+3.155695348699627200000000000000000000000000000000000000e+18"); // cnst267
  generateConstantArray34("maxTime",     "+3.600000000000000000000000000000000000000000000000000000e+19"); // cnst268  if the number of constants changes: don't forget to update NUMBER_OF_CONSTANTS_* in defines.h
