...
void generateAllConstants(void) {
  ...
  generateConstantArray("NmiSqToKmSq",   "+3.429904000000000000000000000000000000000000000000000000e+00");        // cnst088       km     = nmi^2 × (1852 / 1000)^2
  generateConstantArray("AuToM",         "+1.495978707000000000000000000000000000000000000000000000e+11");        // cnst089       m      = au × 149597870700
  generateConstantArray("LyToM",         "+9.460730472580800000000000000000000000000000000000000000e+15");        // cnst090       m      = ly × 299792458 × 3600 × 24 × 365.25
  generateConstantArray("PcToM",         "+3.085677581491367278913937957796471610731921160409179801e+16");        // cnst091       m      = pc × 149597870700 × 648000 / pi
  generateConstantArray("LiToM",         "+5.000000000000000000000000000000000000000000000000000000e+02");        // cnst092       m      = lǐ × 500
  generateConstantArray("YinToM",        "+3.000000000000000000000000000000000000000000000000000000e-02");        // cnst093       m      = yǐn / 0.03
  generateConstantArray("CunToM",        "+3.000000000000000000000000000000000000000000000000000000e+01");        // cnst094       m      = cùn / 30
  generateConstantArray("ZhangToM",      "+3.000000000000000000000000000000000000000000000000000000e-01");        // cnst095       m      = zhàng / 0.3
  ...
  generateConstantArray("ln2piOn2",      "+9.189385332046727417803297364056176398613974736377834128e-01");        // cnst158
  generateConstantArray("1",             "+1.000000000000000000000000000000000000000000000000000000e+00");        // cnst159
  generateConstantArray("3on2",          "+1.500000000000000000000000000000000000000000000000000000e+00");        // cnst160
  generateConstantArray("piOn2",         "+1.570796326794896619231321691639751442098584699687552910e+00");        // cnst161
  generateConstantArray("9on5",          "+1.800000000000000000000000000000000000000000000000000000e+00");        // cnst162
  ...
  generateConstantArray("1260",          "+1.260000000000000000000000000000000000000000000000000000e+03");        // cnst197
  generateConstantArray("1680",          "+1.680000000000000000000000000000000000000000000000000000e+03");        // cnst198
  generateConstantArray("2100",          "+2.100000000000000000000000000000000000000000000000000000e+03");        // cnst199
  generateConstantArray("2520",          "+2.520000000000000000000000000000000000000000000000000000e+03");        // cnst200
  generateConstantArray("3600",          "+3.600000000000000000000000000000000000000000000000000000e+03");        // cnst201
  generateConstantArray("6000",          "+6.000000000000000000000000000000000000000000000000000000e+03");        // cnst202
  generateConstantArray("9999",          "+9.999000000000000000000000000000000000000000000000000000e+03");        // cnst203
  generateConstantArray("10000",         "+1.000000000000000000000000000000000000000000000000000000e+04");        // cnst204
  generateConstantArray("25200",         "+2.520000000000000000000000000000000000000000000000000000e+04");        // cnst205
  generateConstantArray("42000",         "+4.200000000000000000000000000000000000000000000000000000e+04");        // cnst206
  generateConstantArray("73766",         "+7.376600000000000000000000000000000000000000000000000000e+04");        // cnst207
  ...
  generateConstantArray("1e_32",         "+1.000000000000000000000000000000000000000000000000000000e-32");        // cnst215
  generateConstantArray("rt3",           "+1.732050807568877293527446341505872366942805253810380628e+00");        // cnst216 if the number of constants changes: don't forget to update NUMBER_OF_CONSTANTS_* in defines.h
