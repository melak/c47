...
void generateAllConstants(void) {
  ...
  generateConstantArray("Kmphmps",       "+2.777777777777777777777777777777777777777777777777777777e-01"); // cnst99      mps      =  Kmph  * 0.277...   // 2.5/9
  ...
  generateConstantArray("FlozukToMl",    "+2.841306250000000000000000000000000000000000000000000000e+01"); // cnst109      ml     = flozuk × 4.54609e-3 / 160 × 1000000
  generateConstantArray("FlozusToMl",    "+2.957352956250000000000000000000000000000000000000000000e+01"); // cnst110      ml     = flozus × 231 × 0.0254³ / 128 × 1000000
  generateConstantArray("GalusToL",      "+3.785411784000000000000000000000000000000000000000000000e+00"); // cnst111      l      = galus × 231 × 0.0254³ × 1000
  ...
  generateConstantArray("TorrToPa",      "+1.333223684210526315789473684210526315789473684210526316e+02"); // cnst128      pascal = torr × 101325 / 760
    ...
    generateConstantArray("MmhgToPa",    "+1.333223874150000000000000000000000000000000000000000000e+02"); // cnst129      pascal = mm.Hg × 13.5951 × 9.80665
    generateConstantArray("InhgToPa",    "+3.386388640341000000000000000000000000000000000000000000e+03"); // cnst130      pascal = in.Hg × 13.5951 × 9.80665 × 2.54
  ...
  generateConstantArray("_1oneE",        "-3.678794411714423215955237701614608674458111310317678345e-01"); // cnst142
  generateConstantArray("1e_49",         "+1.000000000000000000000000000000000000000000000000000000e-49"); // cnst143
  generateConstantArray("1e_37",         "+1.000000000000000000000000000000000000000000000000000000e-37"); // cnst144
  generateConstantArray("1e_24",         "+1.000000000000000000000000000000000000000000000000000000e-24"); // cnst145
  generateConstantArray("1e_6",          "+1.000000000000000000000000000000000000000000000000000000e-06"); // cnst146
  generateConstantArray("1e_4",          "+1.000000000000000000000000000000000000000000000000000000e-04"); // cnst147
  generateConstantArray("1on10",         "+1.000000000000000000000000000000000000000000000000000000e-01"); // cnst148
  generateConstantArray("1on4",          "+2.500000000000000000000000000000000000000000000000000000e-01"); // cnst149
  generateConstantArray("1on3",          "+3.333333333333333333333333333333333333333333333333333333e-01"); // cnst150
  generateConstantArray("1on2",          "+5.000000000000000000000000000000000000000000000000000000e-01"); // cnst151
  generateConstantArray("egamma",        "+5.772156649015328606065120900824024310421593359399235988e-01"); // cnst152
  generateConstantArray("ln2",           "+6.931471805599453094172321214581765680755001343602552541e-01"); // cnst153
  generateConstantArray("root2on2",      "+7.071067811865475244008443621048490392848359376884740366e-01"); // cnst154
  generateConstantArray("piOn4",         "+7.853981633974483096156608458198757210492923498437764552e-01"); // cnst155
  generateConstantArray("root3on2",      "+8.660254037844386467637231707529361834714026269051903140e-01"); // cnst156
  generateConstantArray("9on10",         "+9.000000000000000000000000000000000000000000000000000000e-01"); // cnst157
  ...
  generateConstantArray("9999",          "+9.999000000000000000000000000000000000000000000000000000e+03"); // cnst200
  generateConstantArray("10000",         "+1.000000000000000000000000000000000000000000000000000000e+04"); // cnst201
  generateConstantArray("25200",         "+2.520000000000000000000000000000000000000000000000000000e+04"); // cnst202
  generateConstantArray("42000",         "+4.200000000000000000000000000000000000000000000000000000e+04"); // cnst203
  generateConstantArray("73766",         "+7.376600000000000000000000000000000000000000000000000000e+04"); // cnst204
  generateConstantArray("1e6",           "+1.000000000000000000000000000000000000000000000000000000e+06"); // cnst205
  generateConstantArray("1e8",           "+1.000000000000000000000000000000000000000000000000000000e+08"); // cnst206
  generateConstantArray("1e9",           "+1.000000000000000000000000000000000000000000000000000000e+09"); // cnst207
  generateConstantArray("2p32",          "+4.294967296000000000000000000000000000000000000000000000e+09"); // cnst208
  generateConstantArray("1e32",          "+1.000000000000000000000000000000000000000000000000000000e+32"); // cnst209
  generateConstantArray("1e_10000",      "+1.000000000000000000000000000000000000000000000000000000e-10000"); // cnst210
  generateConstantArray("995on1000",     "+9.950000000000000000000000000000000000000000000000000000e-01"); // cnst211
  generateConstantArray("1e_32",         "+1.000000000000000000000000000000000000000000000000000000e-32"); // cnst212
  generateConstantArray("rt3",           "+1.732050807568877293527446341505872366942805253810380628e+00"); // cnst213 if the number of constants changes: don't forget to update NUMBER_OF_CONSTANTS_* in defines.h
