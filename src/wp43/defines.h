...
#define VERSION1 "0.108.13.02"     // major release . minor release . tracked build - internal un/tracked subrelease : alpha/beta/rc1

//2023-08-22-0.108.13.02 test status bar
