...
TO_QSPI const int16_t menu_alphaMATH[]   = { ITM_LESS_THAN,                 ITM_LESS_EQUAL,             ITM_EQUAL,                ITM_ALMOST_EQUAL,      ITM_GREATER_EQUAL,           ITM_GREATER_THAN,
                                             ...
                                             ITM_PROD_SIGN,                 ITM_OBELUS,                 ITM_SLASH,                ITM_CROSS,             ITM_MINUS,                   ITM_PLUS,        
...
TO_QSPI const int16_t menu_IO[]          = { ITM_SAVE,                      ITM_LOAD,                   ITM_SAVEST,               ITM_LOADST,            ITM_WRITEP,                  ITM_READP,             
                                             ITM_LOADP,                     ITM_LOADR,                  ITM_LOADSS,               ITM_LOADV,             ITM_LOADSIGMA,               -MNU_PRINT,
                                             ITM_BEEP,                      ITM_TONE,                   ITM_NULL,                 ITM_NULL,              ITM_NULL,                    ITM_NULL                      };   //DL
...
/* 68  */  {.menuItem = -MNU_PLOTTING,    .numItems = sizeof(menu_PLOTTING      )/sizeof(int16_t), .softkeyItem = menu_PLOTTING       },
...
/* 89  */  {.menuItem = -MNU_ANGLECONV_C43,.numItems = sizeof(menu_AngleConv_C43)/sizeof(int16_t), .softkeyItem = menu_AngleConv_C43  },
