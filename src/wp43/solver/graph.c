...
//PLOTTER
  ...
  void fnClDrawMx(void) {
    ...
    fnDeleteVariable(regStats); //    clearRegister(regStats);                  // this should change to delete the named variable STATS once the delete function is available. Until then write 0.0 into STATS.
    if(regStats == INVALID_VARIABLE) {
