...
/*  450 */  { fnStatSum,                    SUM_lnYonX,                  STD_SIGMA "ln" STD_SPACE_6_PER_EM "yx" STD_SUP_MINUS STD_SUP_1, STD_SIGMA "ln" STD_SPACE_6_PER_EM "yx" STD_SUP_MINUS STD_SUP_1, (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
