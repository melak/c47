...
/*  442 */  { fnStatSum,                    SUM_lnXlnY,                  STD_SIGMA "ln" STD_SPACE_HAIR "xy",            STD_SIGMA "ln" STD_SPACE_HAIR "xy",            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/*  450 */  { fnStatSum,                    SUM_lnYonX,                  STD_SIGMA "ln" STD_SPACE_HAIR "yx" STD_SUP_MINUS STD_SUP_1, STD_SIGMA "ln" STD_SPACE_HAIR "yx" STD_SUP_MINUS STD_SUP_1, (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
