...
/* 2117 */  { fnSetGapChar,                 ITM_QUOTE,                   "IWTICK'",                                     "WTICK'",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2130 */  { fnSetGapChar,                 32768+ITM_QUOTE,             "FWTICK'",                                     "WTICK'",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
