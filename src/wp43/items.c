...
/*  523 */  { fnGetSystemFlag,              FLAG_HPBASE,                 "HPBASE",                                      "HPBASE",                                      (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1895 */  { SetSetting,                   PR_HPBASE,                   "HPBASE",                                      "HPBASE",                                      (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1964 */  { fnKeysManagement,             USER_C43,                    "C43",                                         "C43",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
