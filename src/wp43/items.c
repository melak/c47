...
/* 2116 */  { fnSetGapChar,                 ITM_DOT,                     "LSEP" STD_DOT,                                "LSEP" STD_DOT,                                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 2124 */  { fnSetGapChar,                 ITM_SPACE,                   "LSEP" STD_OPEN_BOX STD_OPEN_BOX,              "SEP" STD_OPEN_BOX STD_OPEN_BOX,               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 2125 */  { fnSetGapChar,                 ITM_DOT,                     "LSEP" STD_DOT,                                "LSEP" STD_DOT,                                (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
