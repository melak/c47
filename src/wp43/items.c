...
/* 2112 */  { fnSetGapChar,                 ITM_WDOT,                    "IWDOT " STD_WDOT,                             "WDOT " STD_WDOT,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2113 */  { fnSetGapChar,                 ITM_PERIOD,                  "IPER.",                                       "PER.",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2114 */  { fnSetGapChar,                 ITM_WPERIOD,                 "IWPER " STD_WPERIOD,                          "WPER " STD_WPERIOD,                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2115 */  { fnSetGapChar,                 ITM_COMMA,                   "ICOM,",                                       "COM,",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2116 */  { fnSetGapChar,                 ITM_WCOMMA,                  "IWCOM " STD_WCOMMA,                           "WCOM " STD_WCOMMA,                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2117 */  { fnSetGapChar,                 ITM_QUOTE,                   "ITICK'",                                      "TICK'",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2118 */  { fnSetGapChar,                 ITM_NQUOTE,                  "INTICK " STD_NQUOTE,                          "NTICK" STD_NQUOTE,                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2125 */  { fnSetGapChar,                 32768+ITM_WDOT,              "FWDOT " STD_WDOT,                             "WDOT " STD_WDOT,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2126 */  { fnSetGapChar,                 32768+ITM_PERIOD,            "FPER.",                                       "PER.",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2127 */  { fnSetGapChar,                 32768+ITM_WPERIOD,           "FWPER " STD_WPERIOD,                          "WPER " STD_WPERIOD,                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2128 */  { fnSetGapChar,                 32768+ITM_COMMA,             "FCOM,",                                       "COM,",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2129 */  { fnSetGapChar,                 32768+ITM_WCOMMA,            "FWCOM " STD_WCOMMA,                           "WCOM " STD_WCOMMA,                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2130 */  { fnSetGapChar,                 32768+ITM_QUOTE,             "FTICK'",                                      "TICK'",                                       (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2131 */  { fnSetGapChar,                 32768+ITM_NQUOTE,            "FNTICK " STD_NQUOTE,                          "NTICK" STD_NQUOTE,                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2138 */  { fnSetGapChar,                 49152+ITM_WDOT,              "RWDOT " STD_WDOT,                             "WDOT " STD_WDOT,                              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2139 */  { fnSetGapChar,                 49152+ITM_PERIOD,            "RPER.",                                       "PER.",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2140 */  { fnSetGapChar,                 49152+ITM_WPERIOD,           "RWPER " STD_WPERIOD,                          "WPER " STD_WPERIOD,                           (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2141 */  { fnSetGapChar,                 49152+ITM_COMMA,             "RCOM,",                                       "COM,",                                        (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
/* 2142 */  { fnSetGapChar,                 49152+ITM_WCOMMA,            "RWCOM" STD_WCOMMA,                            "WCOM " STD_WCOMMA,                            (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2154 */  { fnSettingsToXEQ,              NOPARAM,                     "set>TXT",                                     "set>TXT",                                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_NONE         },
...
/* 2162 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED},
};
