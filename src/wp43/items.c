...
/* 2206 */  { fnKmletok100K,                multiply,                    "km/l" STD_SUB_e STD_RIGHT_ARROW "U/hkm",      "km/l" STD_SUB_e STD_RIGHT_ARROW,              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2207 */  { fnKmletok100K,                divide,                      "U/hkm" STD_RIGHT_ARROW "km/l" STD_SUB_e,      "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2208 */  { fnK100Ktokmk,                 multiply,                    "U/hkm" STD_RIGHT_ARROW "km/U",                "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2209 */  { fnK100Ktokmk,                 divide,                      "km/U" STD_RIGHT_ARROW "U/hkm",                "km/kWh" STD_RIGHT_ARROW,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 2212 */  { fnMgeustok100M,               multiply,                    "mge" STD_US STD_RIGHT_ARROW "U/100mi",        "mge" STD_US STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2213 */  { fnMgeustok100M,               divide,                      "U/100mi" STD_RIGHT_ARROW "mge" STD_US,        "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2214 */  { fnK100Mtok100K,               multiply,                    "U/100mi" STD_RIGHT_ARROW "U/hkm",             "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2215 */  { fnK100Mtok100K,               divide,                      "U/hkm" STD_RIGHT_ARROW "U/100mi",             "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
...
/* 2218 */  { fnMgeuktok100M,               multiply,                    "mge" STD_UK STD_RIGHT_ARROW "U/100mi",        "mge" STD_UK STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2219 */  { fnMgeuktok100M,               divide,                      "U/100mi" STD_RIGHT_ARROW "mge" STD_UK,        "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2220 */  { fnK100Mtomik,                 multiply,                    "U/100mi" STD_RIGHT_ARROW "mi/U",              "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2221 */  { fnK100Mtomik,                 divide,                      "mi/U" STD_RIGHT_ARROW "U/100mi",              "mi/kWh" STD_RIGHT_ARROW,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2222 */  { itemToBeCoded,                NOPARAM,                     "Ymmv:",                                       "Ymmv:",                                       (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },

/* 2223 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED},
};
