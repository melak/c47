...
/*  510 */  { fnGetSystemFlag,              FLAG_SBpr,                   "SBpr",                                        "SBpr",                                        (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/*  514 */  { fnGetSystemFlag,              FLAG_SBmatx,                 "SBmatx",                                      "SBmatx",                                      (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/*  515 */  { fnGetSystemFlag,              FLAG_SBtvm,                  "SBtvm",                                       "SBtvm",                                       (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/*  516 */  { fnGetSystemFlag,              FLAG_SBcary,                 "SBcary",                                      "SBcary",                                      (0 << TAM_MAX_BITS) |     0, CAT_SYFL | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1571 */  { itemToBeCoded,                NOPARAM,                     "1571",                                        "1571",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 1572 */  { itemToBeCoded,                NOPARAM,                     "1572",                                        "1572",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 1757 */  { fnHide,                       TM_VALUE,                    "HIDE",                                        "HIDE",                                        (0 << TAM_MAX_BITS) |    99, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     },
...
/* 1915 */  { fnUserJM,                     USER_43S,                    "WP43",                                        "WP43",                                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },//J=V43
...
/* 2016 */  { fnDenMax,                     TM_VALUE,                    "DMX",                                         "DMX",                                         (0 << TAM_MAX_BITS) | MAX_DENMAX, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_16    },
/* 2017 */  { fnSetSignificantDigits,       TM_VALUE,                    "SDIGS",                                       "SDIGS",                                       (0 << TAM_MAX_BITS) |    34, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NUMBER_8     },
...
/* 2162 */  { itemToBeCoded,                NOPARAM,                     "2162",                                        "2162",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 2163 */  { itemToBeCoded,                NOPARAM,                     "2163",                                        "2163",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
/* 2164 */  { itemToBeCoded,                NOPARAM,                     "2164",                                        "2164",                                        (0 << TAM_MAX_BITS) |     0, CAT_FREE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 2167 */  { fnCvtNmiMi,                   multiply,                    "nmi" STD_RIGHT_ARROW "mi.",                   "nmi" STD_RIGHT_ARROW "mi.",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2168 */  { fnCvtNmiMi,                   divide,                      "mi." STD_RIGHT_ARROW "nmi",                   "mi." STD_RIGHT_ARROW "nmi",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2169 */  { fnCvtFurtom,                  multiply,                    "fur" STD_RIGHT_ARROW "m",                     "fur" STD_RIGHT_ARROW "m",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2170 */  { fnCvtFurtom,                  divide,                      "m" STD_RIGHT_ARROW "fur",                     "m" STD_RIGHT_ARROW "fur",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2171 */  { fnCvtFtntos,                  multiply,                    "ftn" STD_RIGHT_ARROW "s",                     "ftn" STD_RIGHT_ARROW "s",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2172 */  { fnCvtFtntos,                  divide,                      "s" STD_RIGHT_ARROW "ftn",                     "s" STD_RIGHT_ARROW "ftn",                     (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2173 */  { fnCvtFpftomps,                multiply,                    "fpf"  STD_RIGHT_ARROW  "m/s",                 "fur/ftn" STD_RIGHT_ARROW "m/s",               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2174 */  { fnCvtFpftomps,                divide,                      "m/s" STD_RIGHT_ARROW "fpf",                   "m/s" STD_RIGHT_ARROW "fur/ftn",               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2175 */  { fnCvtBrdstom,                 multiply,                    "brds" STD_RIGHT_ARROW "m",                    "brds" STD_RIGHT_ARROW "m",                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2176 */  { fnCvtBrdstom,                 divide,                      "m" STD_RIGHT_ARROW "brds",                    "m" STD_RIGHT_ARROW "brds",                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2177 */  { fnCvtFirtokg,                 multiply,                    "fir" STD_RIGHT_ARROW "kg",                    "fir" STD_RIGHT_ARROW "kg",                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2178 */  { fnCvtFirtokg,                 divide,                      "kg" STD_RIGHT_ARROW "fir",                    "kg" STD_RIGHT_ARROW "fir",                    (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2179 */  { fnCvtFpftokph,                multiply,                    "fpf" STD_RIGHT_ARROW "kph",                   "fur/ftn" STD_RIGHT_ARROW "km/h",              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2180 */  { fnCvtFpftokph,                divide,                      "kph" STD_RIGHT_ARROW "fpf",                   "km/h" STD_RIGHT_ARROW "fur/ftn",              (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2181 */  { fnCvtBrdstoin,                multiply,                    "brds" STD_RIGHT_ARROW "in.",                  "brds" STD_RIGHT_ARROW "in.",                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2182 */  { fnCvtBrdstoin,                divide,                      "in." STD_RIGHT_ARROW "brds",                  "in." STD_RIGHT_ARROW "brds",                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2183 */  { fnCvtFirtolb,                 multiply,                    "fir" STD_RIGHT_ARROW "lb.",                   "fir" STD_RIGHT_ARROW "lb.",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2184 */  { fnCvtFirtolb,                 divide,                      "lb." STD_RIGHT_ARROW "fir",                   "lb." STD_RIGHT_ARROW "fir",                   (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2185 */  { fnCvtFpftomph,                multiply,                    "fpf" STD_RIGHT_ARROW "mph",                   "fur/ftn" STD_RIGHT_ARROW "mph",               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2186 */  { fnCvtFpftomph,                divide,                      "mph" STD_RIGHT_ARROW "fpf",                   "mph" STD_RIGHT_ARROW "fur/ftn",               (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2187 */  { fnCvtFpstokph,                multiply,                    "fps" STD_RIGHT_ARROW "kph",                   "ft/s" STD_RIGHT_ARROW "km/h",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2188 */  { fnCvtFpstokph,                divide,                      "kph" STD_RIGHT_ARROW "fps",                   "km/h" STD_RIGHT_ARROW "ft/s",                 (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2189 */  { fnCvtFpstomps,                multiply,                    "fps" STD_RIGHT_ARROW "m/s",                   "ft/s" STD_RIGHT_ARROW "m/s",                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2190 */  { fnCvtFpstomps,                divide,                      "m/s" STD_RIGHT_ARROW "fps",                   "m/s" STD_RIGHT_ARROW "ft/s",                  (0 << TAM_MAX_BITS) |     0, CAT_FNCT | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2191 */  { SetSetting,                   JC_SS,                       "SCR",                                         "SCR",                                         (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },
...
/* 2195 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED},
};
