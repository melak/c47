...
*/
  ...
  void fnK100Mtok100K             (uint16_t unusedButMandatoryParameter) {}
...
/* 2198 */  { fnL100Tokml,                  multiply,                    "l/hkm" STD_RIGHT_ARROW "km/l",                "l/100km" STD_RIGHT_ARROW,                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2199 */  { fnL100Tokml,                  divide,                      "km/l" STD_RIGHT_ARROW "l/hkm",                "km/l" STD_RIGHT_ARROW,                        (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2200 */  { fnKmletok100K,                multiply,                    "km/l" STD_SUB_e STD_RIGHT_ARROW "U/hkm",      "km/l" STD_SUB_e STD_RIGHT_ARROW,              (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2201 */  { fnKmletok100K,                divide,                      "U/hkm" STD_RIGHT_ARROW "km/l" STD_SUB_e,      "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2202 */  { fnK100Ktokmk,                 multiply,                    "U/hkm" STD_RIGHT_ARROW "km/U",                "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2203 */  { fnK100Ktokmk,                 divide,                      "km/U" STD_RIGHT_ARROW "U/hkm",                "km/kWh" STD_RIGHT_ARROW,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2204 */  { fnL100Tomgus,                 multiply,                    "l/hkm" STD_RIGHT_ARROW "mpg" STD_US,          "l/100km" STD_RIGHT_ARROW,                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2205 */  { fnL100Tomgus,                 divide,                      "mpg" STD_US STD_RIGHT_ARROW "l/hkm",          "mpg" STD_US STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2206 */  { fnMgeustok100M,               multiply,                    "mge" STD_US STD_RIGHT_ARROW "U/100mi",        "mge" STD_US STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2207 */  { fnMgeustok100M,               divide,                      "U/100mi" STD_RIGHT_ARROW "mge" STD_US,        "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2208 */  { fnK100Mtok100K,               multiply,                    "U/100mi" STD_RIGHT_ARROW "U/hkm",             "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2209 */  { fnK100Mtok100K,               divide,                      "U/hkm" STD_RIGHT_ARROW "U/100mi",             "kWh/100km" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2210 */  { fnL100Tomguk,                 multiply,                    "l/hkm" STD_RIGHT_ARROW "mpg" STD_UK,          "l/100km" STD_RIGHT_ARROW,                     (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2211 */  { fnL100Tomguk,                 divide,                      "mpg" STD_UK STD_RIGHT_ARROW "l/hkm",          "mpg" STD_UK STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2212 */  { fnMgeuktok100M,               multiply,                    "mge" STD_UK STD_RIGHT_ARROW "U/100mi",        "mge" STD_UK STD_RIGHT_ARROW,                  (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2213 */  { fnMgeuktok100M,               divide,                      "U/100mi" STD_RIGHT_ARROW "mge" STD_UK,        "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2214 */  { fnK100Mtomik,                 multiply,                    "U/100mi" STD_RIGHT_ARROW "mi/U",              "kWh/100mi" STD_RIGHT_ARROW,                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2215 */  { fnK100Mtomik,                 divide,                      "mi/U" STD_RIGHT_ARROW "U/100mi",              "mi/kWh" STD_RIGHT_ARROW,                      (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_ENABLED   | EIM_DISABLED | PTP_NONE         },
/* 2216 */  { itemToBeCoded,                NOPARAM,                     "Ymmv:",                                       "Ymmv:",                                       (0 << TAM_MAX_BITS) |     0, CAT_MENU | SLS_UNCHANGED | US_UNCHANGED | EIM_DISABLED | PTP_DISABLED     },

/* 2217 */  { itemToBeCoded,                NOPARAM,                     "",                                            "Last item",                                   (0 << TAM_MAX_BITS) |     0, CAT_NONE | SLS_ENABLED   | US_UNCHANGED | EIM_DISABLED},
};
